import{a as ee,b as re,c as te,d as ae,e as ie,f as oe,g as ne,h as fe,i as se,j as le,k as ce,l as me,m as _e}from"./chunk-XZXEGACR.js";import{a as $}from"./chunk-NBGFQICB.js";import{a as V}from"./chunk-EEOIV4T6.js";import{a as Z,b as q,c as K,d as Q,e as J}from"./chunk-S3O3GBZ4.js";import{a as k,b as j}from"./chunk-H3HAU5NX.js";import{a as Y}from"./chunk-IBKJV77Q.js";import{a as O,b as C,c as P,d as G,e as x,f as M,g as z,h as U,i as w,j as X,k as B}from"./chunk-ORN4DVMX.js";import{a as W,b as y}from"./chunk-BSBXLWUP.js";import{a as H}from"./chunk-Q337VPSK.js";import{a as N,b as A}from"./chunk-I2IOV5CD.js";import{a as F}from"./chunk-ITFEK2WE.js";import{a as D}from"./chunk-MQ7DXXF5.js";import{a as R,b}from"./chunk-EACWKJ3F.js";import{a as T}from"./chunk-RNGQGRFP.js";import{a as L}from"./chunk-ROCFSSDI.js";import{a as I}from"./chunk-VI5DZS6N.js";import{a as e}from"./chunk-L5WUWJUF.js";var t="openpbrFragmentSamplersDeclaration",de=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=de);var ue={name:t,shader:de};var a="openpbrNormalMapFragmentMainFunctions",pe=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=pe);var ge={name:a,shader:pe};var i="openpbrNormalMapFragmentFunctions",ve=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=ve);var Se={name:i,shader:ve};var o="openpbrConductorReflectance",Ee=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=Ee);var he={name:o,shader:Ee};var n="openpbrAmbientOcclusionFunctions",Ie=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=Ie);var Re={name:n,shader:Ie};var f="openpbrVolumeFunctions",be=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=be);var Le={name:f,shader:be};var s="openpbrNormalMapFragment",Te=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=Te);var Ne={name:s,shader:Te};var l="openpbrBlockNormalFinal",Ae=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=Ae);var Fe={name:l,shader:Ae};var c="openpbrBaseLayerData",De=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=De);var Oe={name:c,shader:De};var m="openpbrCoatLayerData",Ce=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=Ce);var Pe={name:m,shader:Ce};var _="openpbrThinFilmLayerData",Ge=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=Ge);var xe={name:_,shader:Ge};var d="openpbrFuzzLayerData",Me=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=Me);var We={name:d,shader:Me};var u="openpbrAmbientOcclusionData",ye=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=ye);var ze={name:u,shader:ye};var p="openpbrBackgroundTransmission",Ue=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=Ue);var we={name:p,shader:Ue};var g="openpbrEnvironmentLighting",Xe=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=Xe);var He={name:g,shader:Xe};var v="openpbrDirectLightingInit",Be=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=Be);var Ve={name:v,shader:Be};var S="openpbrDirectLighting",ke=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=ke);var Ye={name:S,shader:ke};var E="openpbrBlockPrePass",Ze=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=Ze);var je={name:E,shader:Ze};var h="openpbrPixelShader",qe=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[h]||(e.ShadersStoreWGSL[h]=qe);var Ke=[O,C,L,T,$,F,ee,P,W,k,ue,z,R,D,N,w,I,re,te,ae,U,M,V,G,ie,oe,Y,ne,x,fe,se,le,j,ge,Se,y,Z,he,Re,q,K,Le,b,ce,Ne,Fe,Oe,J,Q,Pe,xe,We,ze,X,we,He,Ve,Ye,H,A,me,je,B,_e];for(let r of Ke)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);var Zt={name:h,shader:qe};export{Zt as openpbrPixelShaderWGSL};
