import{a as e}from"./chunk-L5WUWJUF.js";var r="openpbrDielectricReflectance",f=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=f);var m={name:r,shader:f};var i="openpbrGeometryInfo",t=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=t);var p={name:i,shader:t};var n="openpbrIblFunctions",c=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=l);var F={name:a,shader:l};export{m as a,p as b,R as c,N as d,F as e};
