import{a as e}from"./chunk-L5WUWJUF.js";var t="pbrFragmentExtraDeclaration",g=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=h);var R={name:i,shader:h};var a="pbrHelperFunctions",E=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=E);var U={name:a,shader:E};var r="pbrDirectLightingSetupFunctions",p=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=p);var V={name:r,shader:p};var n="pbrDirectLightingFalloffFunctions",L=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=C);var oe={name:d,shader:C};export{T as a,O as b,R as c,U as d,V as e,W as f,q as g,k as h,j as i,$ as j,oe as k};
