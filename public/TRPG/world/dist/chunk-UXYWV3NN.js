import{a as e}from"./chunk-L5WUWJUF.js";var t="decalFragmentDeclaration",h=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=h);var P={name:t,shader:h};var o="prePassDeclaration",p=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=p);var A={name:o,shader:p};var r="oitDeclaration",u=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=u);var R={name:r,shader:u};var a="lightFragmentDeclaration",m=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=m);var X={name:a,shader:m};var i="lightUboDeclaration",S=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=g);var V={name:s,shader:g};var c="shadowsFragmentFunctions",x=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=x);var G={name:c,shader:x};var l="imageProcessingDeclaration",w=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=w);var Y={name:l,shader:w};var v="imageProcessingFunctions",D=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=D);var J={name:v,shader:D};var d="textureRepetitionFunctions",E=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=E);var $={name:d,shader:E};var n="depthPrePass",T=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=T);var oe={name:n,shader:T};var f="oitFragment",C=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=C);var ie={name:f,shader:C};export{P as a,A as b,R as c,X as d,N as e,V as f,G as g,Y as h,J as i,$ as j,oe as k,ie as l};
