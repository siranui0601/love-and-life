import{a as e}from"./chunk-L5WUWJUF.js";var r="prePassDeclaration",u=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=u);var C={name:r,shader:u};var t="oitDeclaration",l=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=l);var E={name:t,shader:l};var a="lightUboDeclaration",n=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=n);var z={name:a,shader:n};var o="ltcHelperFunctions",h=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=h);var b={name:o,shader:h};var f="clusteredLightingFunctions",m=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=m);var k={name:f,shader:m};var v="shadowsFragmentFunctions",S=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=S);var N={name:v,shader:S};var i="imageProcessingDeclaration",x=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=x);var X={name:i,shader:x};var s="imageProcessingFunctions",w=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=w);var B={name:s,shader:w};var c="textureRepetitionFunctions",g=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=g);var q={name:c,shader:g};var d="depthPrePass",T=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=T);var K={name:d,shader:T};var p="oitFragment",y=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=y);var ee={name:p,shader:y};export{C as a,E as b,z as c,b as d,k as e,N as f,X as g,B as h,q as i,K as j,ee as k};
