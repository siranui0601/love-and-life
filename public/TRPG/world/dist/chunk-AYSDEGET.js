import{a as Re}from"./chunk-GMETR6MV.js";import{a as ie,b as ae,c as ne,d as fe,e as oe,f as te,g as ce,h as le,i as de,j as se,k as Ee,l as me,m as Se}from"./chunk-XZXEGACR.js";import{a as j}from"./chunk-EEOIV4T6.js";import{a as $,b as re}from"./chunk-H3HAU5NX.js";import{a as ee}from"./chunk-IBKJV77Q.js";import{a as K,b as Z}from"./chunk-WR5MIA6Z.js";import{a as b,b as U,c as G,d as B,e as y,f as W,g as H,h as k,i as X,j as q,k as Q}from"./chunk-ORN4DVMX.js";import{a as Y,b as w,c as z}from"./chunk-EFTOQV4X.js";import{a as V,b as x}from"./chunk-BSBXLWUP.js";import{a as J}from"./chunk-Q337VPSK.js";import{a as F,b as g}from"./chunk-I2IOV5CD.js";import{a as P}from"./chunk-ITFEK2WE.js";import{a as h}from"./chunk-MQ7DXXF5.js";import{a as L,b as _}from"./chunk-EACWKJ3F.js";import{a as D}from"./chunk-RNGQGRFP.js";import{a as M}from"./chunk-ROCFSSDI.js";import{a as T}from"./chunk-VI5DZS6N.js";import{a as e}from"./chunk-L5WUWJUF.js";var i="samplerFragmentAlternateDeclaration",Ce=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=Ce);var ue={name:i,shader:Ce};var a="pbrFragmentSamplersDeclaration",pe=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=pe);var ve={name:a,shader:pe};var n="pbrBlockAlbedoOpacity",Ie=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=Ie);var Ae={name:n,shader:Ie};var f="pbrBlockReflectivity",Ne=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=Ne);var Oe={name:f,shader:Ne};var o="pbrBlockAmbientOcclusion",Te=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=Te);var Le={name:o,shader:Te};var t="pbrBlockAlphaFresnel",_e=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=_e);var Me={name:t,shader:_e};var c="pbrBlockAnisotropic",De=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=De);var Fe={name:c,shader:De};var l="pbrBlockReflection",ge=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=ge);var Pe={name:l,shader:ge};var d="pbrBlockSheen",he=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=he);var be={name:d,shader:he};var s="pbrBlockClearcoat",Ue=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=Ue);var Ge={name:s,shader:Ue};var E="pbrBlockIridescence",Be=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=Be);var ye={name:E,shader:Be};var m="pbrBlockSubSurface",We=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=We);var Ve={name:m,shader:We};var S="pbrBlockNormalFinal",xe=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=xe);var He={name:S,shader:xe};var R="pbrBlockLightmapInit",ke=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=ke);var Xe={name:R,shader:ke};var C="pbrBlockGeometryInfo",Ye=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=Ye);var we={name:C,shader:Ye};var u="pbrBlockReflectance",ze=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=ze);var Ke={name:u,shader:ze};var p="pbrBlockDirectLighting",qe=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=qe);var Ze={name:p,shader:qe};var v="pbrBlockFinalLitComponents",Je=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=Je);var Qe={name:v,shader:Je};var I="pbrBlockFinalUnlitComponents",je=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=je);var $e={name:I,shader:je};var A="pbrBlockFinalColorComposition",er=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=er);var rr={name:A,shader:er};var N="pbrBlockPrePass",ir=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=ir);var ar={name:N,shader:ir};var O="pbrPixelShader",nr=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[O]||(e.ShadersStoreWGSL[O]=nr);var fr=[b,U,M,D,Re,P,ie,G,V,ue,$,ve,H,L,h,F,X,T,ae,ne,fe,k,W,j,B,oe,te,ee,ce,y,le,de,se,re,Y,w,x,K,Ae,Oe,Le,Me,Fe,Pe,be,Ge,ye,Ve,_,Ee,z,He,q,Xe,we,Ke,Ze,Z,Qe,$e,rr,J,g,me,ar,Q,Se];for(let r of fr)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);var Ea={name:O,shader:nr};export{Ea as pbrPixelShaderWGSL};
