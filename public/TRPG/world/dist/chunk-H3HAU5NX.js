import{a as e}from"./chunk-L5WUWJUF.js";var r="pbrFragmentReflectionDeclaration",i=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=i);var o={name:r,shader:i};var a="pbrIBLFunctions",n=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=n);var c={name:a,shader:n};export{o as a,c as b};
