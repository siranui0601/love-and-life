...
const routeMode = "companions";
const seed = process.env.TRPG_DAY100_SEED || "trpg-day100-route-companions-v1";
...
class Day100CompanionRouteRunner extends Day100GameRunner {
  constructor(options = {}) {
    super(options);
  ...
  async run() {
    ...
    result.report.routeMode = routeMode;
...
const runner = new Day100CompanionRouteRunner({
  playerName: process.env.TRPG_DAY100_PLAYER_NAME || "百日の旅人・仲間を繋ぐ者",
  seed,
...
console.log("# Day100 route trial: companions\n");
