...
import { AUTHORED_MISSION_T03_DAY8_ONSET_INTERNALS } from "../../../src/server/trpg/content/authored-mission-t03-day8-onset.js";

const data = loadTrpgGameData();
const { ONSET_MINUTE, RUMOR_ID, syncCanonicalT03Day8Onset } = AUTHORED_MISSION_T03_DAY8_ONSET_INTERNALS;
