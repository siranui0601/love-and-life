...
test("chain route does not oscillate to a later active mission before an earlier trouble", () => {
  ...
  state.trouble = {
    ...
    T15: {
      firstRumorMinute: 100,
      firstMissionMinute: 120,
      finalTroubleStatus: "active",
    },
  };
  const routeModel = {
    troubles: [
  ...
  const save = baseSave({
    ...
    choices: [
      {
        choiceId: "T15-INFO",
        actionId: "INSPECT:LOC_TRADE_PORT:1",
        missionId: "MSN-T15",
        label: "港の様子を調べる",
      },
    ],
