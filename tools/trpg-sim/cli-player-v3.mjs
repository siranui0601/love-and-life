...
} from "./lib/player-suite-v3-final.mjs";
...
const report = await runIntegratedPlayerSimulationSuiteV3Final({ profiles: PLAYER_PROFILES });
const markdown = renderPlayerSimulationMarkdownV3Final(report);
