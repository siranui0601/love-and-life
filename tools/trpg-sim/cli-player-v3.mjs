...
} from "./lib/player-suite-v3-deep.mjs";
...
const report = await runIntegratedPlayerSimulationSuiteV3Deep({ profiles: PLAYER_PROFILES });
const markdown = renderPlayerSimulationMarkdownV3Deep(report);
