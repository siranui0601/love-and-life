...
export function canMigrateContent(record,content) {
 ...
 if(['world-10d-24de1ef85209','world-10d-10c3365b9e26','world-10d-ec2c41296f3c'].includes(record.contentRevision)&&(content.revision!=='world-10d-940b5356c6a8'||createHash('sha256').update(JSON.stringify(content)).digest('hex')!=='5594baac95de746eb873321e3c074e6499f9f233cb32acb2e1fc8ce4fce3120f'))return false;
