...
export function canMigrateContent(record,content) {
 ...
 if(['world-10d-be0609b3b3b0','world-10d-4de4bc7caf72','world-10d-1620f79180c0','world-10d-c0ca1f03faba','world-10d-940b5356c6a8','world-10d-24de1ef85209','world-10d-10c3365b9e26','world-10d-ec2c41296f3c'].includes(record.contentRevision)&&createHash('sha256').update(JSON.stringify(content)).digest('hex')!==reviewedTargets.get(content.revision))return false;
