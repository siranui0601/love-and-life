...
export function canMigrateContent(record,content) {
 ...
 if(['world-10d-24de1ef85209','world-10d-10c3365b9e26'].includes(record.contentRevision)&&(content.revision!=='world-10d-ec2c41296f3c'||createHash('sha256').update(JSON.stringify(content)).digest('hex')!=='095e3f7e79de4ae8d7e86d0bbd405afa0203dfbd70ded2bb78db867697cca388'))return false;
