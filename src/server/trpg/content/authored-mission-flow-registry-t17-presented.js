import * as core from "./authored-mission-flow-registry-t17-final.js";
import { T17_CAPITAL_SECOND_SUMMONING_PACK as P } from "./authored/missions/t17-capital-second-summoning.js";

export * from "./authored-mission-flow-registry-t17-final.js";
...
export function applyAuthoredMissionFlowAction(runtime, action, result) {
  ...
  if (kind === "navigator_focus") {
    ...
    result.summary = "三つの調査方針を見直し、別の因果線から第二召喚を追うことにした。";
