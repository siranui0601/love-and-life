...
const LEAD_ROWS = [
  ...
  ["stable_requisition_sequence", "LOC_TRADE_STABLE", "馬市・徴発札保管所", "厩舎と荷車の徴発順から、上陸後の内陸移動時刻を割り出す", GROUPS[3][2], "港近くの荷車から順に押さえ、夜明け前に王都街道へ出る隊列が組まれていた。", 40, "馬、御者、橋の通過札を並べ、港で終わらない上陸計画を示す。"],
  ...
  ["capital_road_survey", "LOC_TRADE_STABLE", "馬市裏・街道測量図庫", "外国測量図と荷車試走を重ね、王都までの軍用経路を特定する", GROUPS[5][0], "橋の耐荷重、井戸、狭窄部が隊列幅で測られ、目的地は王都西門まで続いていた。", 45, "観光地図では不要な数値に注目し、何を通すための測量かを示す。"],
