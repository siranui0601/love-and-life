export const T01_RESCUE_SCENES = Object.freeze([
  ...
  Object.freeze({
    sceneId: "t01.search.wolf_pursuit",
    priority: 1080,
    presentationOnly: true,
    when: Object.freeze({ all: Object.freeze([
      Object.freeze({ path: "mission.id", op: "eq", value: "MSN-T01" }),
      Object.freeze({ path: "mission.stepId", op: "eq", value: "search" }),
      Object.freeze({ path: "outcome.discovery.id", op: "eq", value: "T01-CLUE-WOLF-PURSUIT" }),
      Object.freeze({ path: "location.facilityId", op: "eq", value: "LOC_FARM_EDGE" }),
    ]) }),
    narrative: "土に食い込んだ赤牙狼の爪痕は、小さな靴跡の後ろから現れ、途中で斜面側へ回り込んでいる。偶然通りかかった獣ではない。狼は逃げる少年を追い込み、見張り小屋の裏へ進路を絞っていた。",
    beats: Object.freeze([]),
    choices: Object.freeze([]),
  }),
  Object.freeze({
    sceneId: "t01.search.jacket_thread",
    priority: 1070,
    presentationOnly: true,
    when: Object.freeze({ all: Object.freeze([
      Object.freeze({ path: "mission.id", op: "eq", value: "MSN-T01" }),
      Object.freeze({ path: "mission.stepId", op: "eq", value: "search" }),
      Object.freeze({ path: "outcome.discovery.id", op: "eq", value: "T01-CLUE-JACKET-THREAD" }),
      Object.freeze({ path: "location.facilityId", op: "eq", value: "LOC_FARM_EDGE" }),
    ]) }),
    narrative: "道端の枝に、フィンの上着と同じ青い糸が絡んでいる。その先では子どもの足跡だけが道を外れ、見張り小屋裏の崩れた斜面へ続いていた。糸は新しく、雨や泥にもまだ色を奪われていない。",
    beats: Object.freeze([]),
    choices: Object.freeze([]),
  }),
  Object.freeze({
  ...
  Object.freeze({
    sceneId: "t01.search.wolf_blockade",
    priority: 1040,
    presentationOnly: true,
    when: Object.freeze({ all: Object.freeze([
      Object.freeze({ path: "mission.id", op: "eq", value: "MSN-T01" }),
      Object.freeze({ path: "mission.stepId", op: "eq", value: "search" }),
      Object.freeze({ path: "outcome.discovery.id", op: "eq", value: "T01-CLUE-WOLF-BLOCKADE" }),
      Object.freeze({ path: "location.facilityId", op: "eq", value: "LOC_FARM_EDGE" }),
    ]) }),
    narrative: "風下から見張り小屋の裏をうかがうと、赤牙狼が崩れた斜面の出口を塞いでいる。さらに奥からは、息を殺そうとして失敗した子どもの咳が聞こえた。フィンを連れ出すには、まずこの狼を退けなければならない。",
    beats: Object.freeze([]),
    choices: Object.freeze([]),
  }),
  Object.freeze({
    ...
    choices: Object.freeze([
      ...
      Object.freeze({
        ...
        command: Object.freeze({ type: "MOVE_WITH_COMPANION", companionNpcId: "NPC001", targetFacilityId: "LOC_FARM_SQUARE" }),
  ...
  Object.freeze({
    ...
    beats: Object.freeze([
      Object.freeze({ kind: "npc", actorId: "NPC001", text: "母さん……ただいま。心配かけて、ごめんなさい。この人が狼から助けて、ここまで連れてきてくれたんだ。", emotion: "安堵" }),
      Object.freeze({ kind: "npc", actorId: "NPC002", text: "フィン！　よかった……本当に、生きて帰ってきてくれてよかった。旅人さん、この子を助けてくださって、ありがとうございます。", emotion: "涙と安堵" }),
      Object.freeze({ kind: "npc", actorId: "NPC003", text: "村を預かる者として礼を言う。少年を見つけ、危険な道を連れ帰ってくれたことを、村は忘れない。", emotion: "深い感謝" }),
    ]),
    choices: Object.freeze([]),
  }),
]);
