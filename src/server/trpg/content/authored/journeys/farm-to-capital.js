...
export const FARM_TO_CAPITAL_SCENES = Object.freeze([
  Object.freeze({
    ...
    narrative: "田園の村を出て一時間ほど。畑の切れ目から石造りの外壁がせり上がり、やがて王都の門をくぐる。広い道から外れて下層へ下るほど、石畳は継ぎはぎになり、荷車と呼び声が狭い路地へ重なっていく。辿り着いた下層の安宿は、豪華ではないが、旅装を解いて食事と寝床を確保できる場所だった。帳場の主人は旅装を見て、『装備を見るなら、坂を上がった王都武器屋だ。剣だけじゃない。槍も弓も杖もあるし、買えなくても試しに握らせてもらえる』と教えた。",
    narrativeByWeatherTag: Object.freeze({
      rain: "田園の村を出る頃から続いた雨で、近郊道は浅い泥へ変わっていた。一時間ほど歩くと、雨幕の向こうに王都の外壁が現れる。門を抜け、濡れた荷車を避けながら下層へ下ると、軒先から落ちる雫の奥に安宿の灯りが見えた。帳場の主人は濡れた旅装を見て、『装備を乾かすついでに、坂の上の王都武器屋を覗くといい。剣も槍も弓も杖も、買う前に試せる』と教えた。",
      storm: "強い風に身体を傾けながら近郊道を進む。王都の外壁へ着くまでの一時間が、普段より長く感じられた。門内でも雨風は路地を吹き抜け、看板が軋んでいる。下層の安宿へ滑り込むと、閉めた戸の向こうでようやく風音が遠のいた。帳場の主人は『風が弱まったら坂の上の王都武器屋へ行くといい。剣だけでなく槍、弓、杖も扱っていて、試し持ちもできる』と道を示した。",
      snow: "近郊道の轍には白いものが残り、吐く息が王都へ近づくほど濃くなる。一時間ほどで外壁へ着き、門を抜けて下層へ入る。石段の端へ寄せられた雪を避けて進むと、安宿の煙突から細い煙が上がっていた。帳場の主人は火のそばを勧めながら、『装備を整えるなら坂の上の王都武器屋だ。剣、槍、弓、杖を試して、自分に合うものを探せる』と教えた。",
      fog: "田園の村を離れると、近郊道の先は薄い霧へ沈んだ。歩いて一時間ほど、輪郭だけだった王都の外壁が間近に現れる。門を越え、鐘と荷車の音を頼りに下層へ下ると、霧の中から安宿の看板が浮かんだ。帳場の主人は戻る道を説明したあと、『坂を上がれば王都武器屋がある。剣だけでなく槍や弓、杖も試せるから、目印にするといい』と付け加えた。",
      clear: "田園の村の畑を背に近郊道を進むと、一時間ほどで王都の外壁が見えてきた。門をくぐれば、広い道、荷車、露店の声が一度に押し寄せる。人波を避けて下層へ下り、継ぎはぎの石畳を辿ると、安宿の色褪せた看板へ着く。帳場の主人は王都での足場を説明し、『装備を見るなら坂の上の王都武器屋へ行くといい。剣、槍、弓、杖を扱っていて、買う前に試せる』と教えた。",
    }),
    beats: Object.freeze([]),
