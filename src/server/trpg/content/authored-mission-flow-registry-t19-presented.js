import * as core from "./authored-mission-flow-registry-t19-final.js";
import { T19_BLACKRIDGE_INVASION_PACK as P } from "./authored/missions/t19-blackridge-invasion.js";

export * from "./authored-mission-flow-registry-t19-final.js";
...
export function applyAuthoredMissionFlowAction(runtime, action, result) {
  ...
  if (kind === "navigator_focus") {
    ...
    result.summary = "三つの調査方針を見直し、別の因果線から森突破侵攻を追うことにした。";
