import * as runtime from "./authored-mission-flow-t19-runtime.js";
import {
  T19_BLACKRIDGE_INVASION_PACK as P,
  T19_CONTINUITY_CONTRACT as CONTRACT,
} from "./authored/missions/t19-blackridge-invasion.js";

export * from "./authored-mission-flow-t19-runtime.js";

const F = Object.freeze;
const { navigatorFocuses, interventions: INTERVENTIONS } = runtime.T19_RUNTIME_INTERNALS;
...
export const AUTHORED_MISSION_FLOW_SCENES = F([
  ...runtime.AUTHORED_MISSION_FLOW_SCENES,
  ...t19Scenes(),
].sort((left, right) =>
