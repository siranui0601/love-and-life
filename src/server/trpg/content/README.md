...
- T12では五つの独立事実分類、各三経路、取得順、三導入、三解決を組み合わせ、過去事件を数える前から262,440の決定論的到達形を持つ。
...
T13 treats the king slime as six linked but independently provable problems: growth source, safe separation, world-tree/seal coupling, Blackridge innocence, civilian water/evacuation, and post-intervention ecological recovery. A generic three-choice navigator exposes three focuses, two evidence classes under each focus, and three handwritten routes per class. This makes all 729 evidence profiles and all 720 class acquisition orders reachable from each of the three opening lenses before the three final resolutions are chosen, for 4,723,920 deterministic route shapes before date and prior-trouble modifiers. The encounter escalates through ENC-0015, ENC-0016, ENC-0017 and ENC-0018 before the Day60 collapse, then uses the existing post-collapse ENC-0068 and ENC-0020 contracts through Day89. The selected route, context and evidence order persist as the T13 branch signature for T16, T18 and T19.
