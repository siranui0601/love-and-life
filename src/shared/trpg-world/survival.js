...
export function advanceRescue(state,content,seconds) {
 ...
 const eligible=n=>n.hp>0&&!n.travel&&!n.captive&&n.detention?.status!=='held'&&!n.custodyAssignment&&!n.operationMember&&!n.relocationAssignment&&!n.causalAssignment&&n.region===p.region;
