...
export function projectWorld(state,content) {
  ...
  projected.perception=playerPerception(state,content,projected);delete projected.player.observedPlaces;delete projected.player.observedExits;delete projected.player.siteSearches;return projected;
}
